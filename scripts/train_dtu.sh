...
python -m torch.distributed.launch --nproc_per_node=6 train_mvs4.py --logdir $DTU_LOG_DIR --dataset=dtu_yao4_raw_crop --batch_size=2 --trainpath=$DTU_TRAINING --summary_freq 100 \
